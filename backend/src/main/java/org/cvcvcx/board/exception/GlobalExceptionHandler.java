...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleEmailDuplicateException(BadCredentialsException ex){
    ...
    public ResponseEntity<ErrorResponse> handleEmailDuplicateException(Exception ex){
